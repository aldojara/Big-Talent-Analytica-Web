export const siteConfig = {
  ...
  socialLinks: [
    ...
    { label: "YouTube", href: "/comunidad/canales-y-redes", glyph: "play" },
    { label: "LinkedIn", href: "/comunidad/canales-y-redes", glyph: "in" },
    { label: "Email", href: "mailto:hello@bigtalentanalytica.com", glyph: "mail" },
  ],
} as const;
